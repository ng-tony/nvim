...
vim.g.terminal_color_4 = "#97bfce"
vim.g.terminal_color_5 = "#ba8baf"
vim.g.terminal_color_6 = "#86c1b9"
vim.g.terminal_color_7 = "#d8d8d8"
vim.g.terminal_color_8 = "#585858"
vim.g.terminal_color_9 = "#ab4642"
vim.g.terminal_color_10 = "#a1b56c"
vim.g.terminal_color_11 = "#f7ca88"
vim.g.terminal_color_12 = "#7cafc2"
vim.g.terminal_color_13 = "#ba8baf"
vim.g.terminal_color_14 = "#86c1b9"
vim.g.terminal_color_15 = "#f8f8f8"
vim.g.cmp_enabled = true -- enable completion at start
vim.g.autopairs_enabled = true -- enable autopairs at start
vim.g.diagnostics_enabled = true -- enable diagnostics at start
vim.g.status_diagnostics_enabled = true -- e
vim.opt.formatoptions:remove({ "c", "r", "o" }) -- This is a sequence of letters which describes how automatic formatting is to be done

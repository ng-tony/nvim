...
--
keymap("n", "<leader>mm", "<Plug>RestNvim")
keymap("n", "<leader>mp", "<Plug>RestNvimPreview")
-- keymap("n", "<leader>mm", ':call Exec_on_term("normal", "curr")<CR>')
-- keymap("v", "<leader>mm", ':call Exec_on_term("visual", "curr"")<CR>')
